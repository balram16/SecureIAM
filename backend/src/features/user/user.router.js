...
router.post('/:id/policies', iamMiddleware('iam:AttachUserPolicy'), userController.attachPolicy);
...
router.put('/:id/boundary', iamMiddleware('iam:PutUserBoundary'), userController.putBoundary);
